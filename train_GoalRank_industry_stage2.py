...
parser.add_argument('--cuda', type=int, default=6, help='cuda device number; set to -1 (default) if using cpu')
...
parser.add_argument('--generative_list_num', default=20, help='generative_list_num_weight')
parser.add_argument('--path_evaluator', default='Evaluator/evaluator_industry_20.pth', help='path_evaluator')

parser.add_argument('--G_weight', default=1.0, help='G_weight')
parser.add_argument('--R_guide_G_weight', default=0.01, help='R_guide_G_weight')
